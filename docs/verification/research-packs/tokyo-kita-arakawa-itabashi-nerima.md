# Research pack: tokyo-kita-arakawa-itabashi-nerima
...
- **北区**: Skipped (tile_coverage_warning)
- **荒川区**: Skipped (tile_coverage_warning)
...
|---|---|---|---|---|
| 北区 | 第１種中高層住居専用地域(16.8%) | 31.6% | 준방화지역 | no_data |
| 荒川区 | 準工業地域(38.6%) | 42.3% | 준방화지역 | no_data |

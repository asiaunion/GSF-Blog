...
**Style:** Economist-inspired layout — GSF green accent bar (`#10b981`), Y-axis on the right, labels stacked **bottom-right only** (`Seoul` / `Outskirts`). Details stay in MDX `<figcaption>`.

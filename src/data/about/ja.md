...
<div class="career-timeline">
  <div class="timeline-item">
    ...
    <div class="timeline-content">
      ...
      <p>韓国で経済学を学んだのち、損害保険会社で約8年間勤務しました。最初の2年間はオフィス用不動産の賃貸借業務を担当し、商業用不動産契約の実務を経験しました。その後6年間は商品企画部門で、保険商品の企画と統計分析を担当しました。データとリスクに向き合う日々が、投資家としての視点を築いてくれた時間だったと感じています。</p>
    </div>
  </div>
  <div class="timeline-item">
    <div class="timeline-marker"></div>
    <div class="timeline-content">
      ...
      <h4 class="timeline-role">不動産競売 · ソウル多世帯住宅</h4>
      <p>退職後は不動産競売を通じて、ソウルの多世帯住宅を落札しました。内装・外装をフルリノベーションしたうえで入居者を募集し、運営ののちに利益を確定させて売却しました。現在は仁川の旧市街に再開発・再建築物件を保有しており、売却タイミングをリアルタイムで検討しています。</p>
    </div>
  </div>
  <div class="timeline-item timeline-item--current">
    ...
    <div class="timeline-content">
      ...
      <p>日本橋で中古マンションを購入し、引越しました。物件探しから契約・住宅ローン審査・残金決済・登記まで、日本の不動産取引のすべてのプロセスを自ら経験しました。韓国と日本、二つの不動産市場を実務レベルで比較できるようになった契機でもあります。</p>
    </div>
  </div>
</div>

...
<div class="career-timeline">
  <div class="timeline-item">
    ...
    <div class="timeline-content">
      ...
      <h4 class="timeline-role">損害保険会社 · 約8年間</h4>
      <p>韓国で経済学を学んだのち、損害保険会社に入社し約8年間勤務しました。最初の2年間はオフィス用不動産の賃貸借業務を担当し、商業用不動産契約の実務を経験しました。その後6年間は商品企画部門で、保険商品の企画と統計分析を担当しました。データとリスクに向き合う日々が、投資家としての視点を築いてくれた時間だったと感じています。</p>
    </div>
  </div>
  <div class="timeline-item">
    <div class="timeline-marker"></div>
    <div class="timeline-content">
      ...
      <h4 class="timeline-role">不動産投資 · ソウル競売 & 仁川再開発</h4>
      <p>退職後、本格的に不動産投資を始めました。裁判所の競売でソウルの多世帯住宅を落札し、フルリノベーション後に賃貸運営を経て利益確定・売却しました。同時に土地投資や仁川の再開発・再建築案件への投資も並行しました。この時期に2年間タイ・チェンマイに滞在（2016–2018年）し、東南アジアの不動産市場にも間接的に触れる機会を得ました。</p>
    </div>
  </div>
  <div class="timeline-item">
    <div class="timeline-marker"></div>
  ...
  <div class="timeline-item timeline-item--current">
    ...
    <div class="timeline-content">
      ...
      <p>日本橋で中古マンションを購入し、引越しました。物件探しから契約・住宅ローン審査・残金決済・登記まで、日本の不動産取引のすべてのプロセスを自ら経験しました。韓国と日本、二つの不動産市場を実務レベルで比較できるようになった契機でもあります。投資家であり起業家としての道を模索しており、このブログはその過程の記録です。</p>
...
<div class="about-pillars">
  <div class="pillar-card">
    ...
    <h4>都市型投資インサイト</h4>
    <p>東京・日本橋を中心とした資産成長の可能性と洞察</p>
  </div>
  <div class="pillar-card">
    <span class="pillar-icon">📊</span>
    <h4>日韓マクロ・イシュー</h4>
    <p>為替、金利、両国のあいだに流れる経済とビジネスのイシュー</p>
  </div>
  <div class="pillar-card">
    <span class="pillar-icon">🗼</span>
    <h4>東京ライフ</h4>
    <p>日本橋と都心の暮らし、日韓家族の日常、ローカル・レポート</p>
  </div>
  <div class="pillar-card">
    <span class="pillar-icon">✍️</span>
    <h4>個人エッセイ</h4>
    <p>経験と失敗、そして価値観についての記録</p>
  </div>
</div>

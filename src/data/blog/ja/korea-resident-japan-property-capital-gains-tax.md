...
しかし、韓国居住者による日本不動産の売却には、日本と韓国の税法が同時に適用されます。そのため、売買契約の直前になって準備を始めるのでは遅い場合があります。
...
数日の違いでも税負担は大きく変わることがあるため、売却時期の検討も税務計画の一部として重要です。
...
### 韓国での申告スケジュール
- **予定申告**: 不動産の譲渡日が属する月の末日から2ヶ月以内に, 所轄税務署で予定申告と納税を行う必要があります。 <sup><a href="#source-7" id="cite-7">7</a></sup> 通常、予定申告を適正に完了した1件の譲渡のみである場合は、翌年5月の確定申告義務が免除されます。 <sup><a href="#source-7" id="cite-7">7</a></sup>
...
5年の境界線に近い物件であれば、契約日を数週間調整するだけで適用税率が大きく変わります。単純な日数計算ではなく、売却年の1月1日を基準としたシミュレーションを行うことが安全です。

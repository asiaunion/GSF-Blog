...
2. **供給条件** — 都心部の新築マンション供給がタイトだという見方はありますが、供給量と価格下支えの因果は、地域・時期ごとに別途確認する必要があります。
3. **低いオフィス空室率** — 三鬼商事の2026年3月の月次データでは、都心5区のオフィス空室率は**2.22%**<sup class="source-ref"><a href="#source-3" id="cite-3">3</a></sup>。この数値はオフィス指標であり、港区・千代田区の小型住宅ユニットの空室・回転速度は別資料で確認する必要があります。

日本は先進国の中で**外国人の不動産取得に制限がほぼない**唯一の市場です。ビザ、永住権、政府承認のいずれも不要です。このガイドは「では、どう始めればよいのか」という問いに体系的にお答えするために書かれました。
...
- **高度専門職** — 70ポイント以上なら3年、80ポイント以上なら**1年での永住権**取得が可能<sup class="source-ref"><a href="#source-14" id="cite-14">14</a></sup>
- **10年連続在留** → 永住権ルート
...
この記事は**ハブ（Hub）**です。全体の地形図を把握したうえで、各チャプター末尾の「深掘りリンク」をたどれば、データと事例を中心とした詳細な分析にアクセスできます。東京の不動産投資は、一本の記事で完結するテーマではありません。このクラスターをブックマークして、投資のステージごとに必要なチャプターを開いていただくことをおすすめします。

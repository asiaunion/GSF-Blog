...
**賃貸需要の構造的変化**: 虎ノ門と港区に移動する韓国人専門職やスタートアップ創業者の増加に伴い、2023年以降、短期フレキシブル入居可能な家具付きアパートへの需要が急増しました。虎ノ門ヒルズと麻布台ヒルズは、森ビルが企画段階からグローバル企業をターゲットに開発した複合施設であるため、テナント選定自体が空室が生じる前に行われる構造です。同じ森ビル開発事例（アークヒルズ、虎ノ門ヒルズ ステーションタワー）で繰り返し観察されてきたパターンであり、東京全体の市場がやや軟化する局面でも吸収ペースが速く維持される理由です。（[三鬼商事 オフィスレポート, 2025](https://www.e-miki.com/market/)）

**麻布台ヒルズ効果**: 2024年の森JPタワーおよび麻布台ヒルズの開業は、港区のプレミアム住宅供給構造を根本的に再編しました。住宅タワーの初期入居者の相当数が韓国系専門職—経営幹部、投資家、グローバルコリア奨学金帰国者—であることが知られています。周辺の1LDK物件の売出し価格はこうしたエリート需要の増加に反応していますが、現時点の具体的な価格については、宅地建物取引業者または[国土交通省 不動産情報ライブラリ](https://www.reinfolib.mlit.go.jp/)を通じてご確認ください。

**スタートアップエコシステム → オフィス需要**: 虎ノ門でのKスタートアップ急増は、単なるコミュニティの話にとどまりません。検証可能なオフィス需要の直接的なドライバーです。韓国輸出入銀行のデータによると、2024年に日本で新規法人を設立した韓国企業・個人は**316社**と過去最多を記録し、2025年の1〜9月時点ですでに318社と年間記録を更新しました。韓国系企業は虎ノ門・赤坂エリアの30〜100㎡のフレキシブルオフィスを好む傾向が強く、東京全体の空室率が小幅回復傾向にある中でも、小型Bプラスグレードのオフィス需要を構造的に下支えしています。

...
지금의 환경은 참을 수 없을 만큼 유혹적입니다. USD/JPY가 145\~160 사이를 오가고 KRW/JPY가 한국 투자자인 우리에게 역사적인 진입 찬스를 주고 있기 때문입니다. 하지만 저는 **FX를 레버리지로 볼 뿐, 알파(초과 수익)라고 보지는 않습니다.** 환율은 결과를 양방향으로 증폭시킬 뿐이며, 특히 우리가 가장 원하지 않는 순간—예를 들어 금융 위기나 지정학적 스트레스 상황—에 전혀 다른 방향으로 튀어버릴 수 있다는 점을 상기해야 합니다.

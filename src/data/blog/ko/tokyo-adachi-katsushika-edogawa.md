---
title: "아다치·가쓰시카·에도가와 집값 비교 — 도쿄 동부 3구 [Ep.8·2026]"
...
마지막으로 江戸川区를 함께 보면 세 구의 차이가 조금 더 선명해집니다. 江戸川区는 도쿄 23구의 가장 동쪽에 위치합니다. 구의 동쪽 경계가 곧 千葉県(지바현)과의 경계이며, 江戸川 강이 그 경계를 이룹니다. 도쿄이지만 지바와 접하는 지역 — 이 위치 때문에 오랫동안 '외곽'의 이미지를 가져왔습니다.

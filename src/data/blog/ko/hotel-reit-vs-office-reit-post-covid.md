...
<p class="post-section-heading">1. 회복의 정의를 먼저 맞춰야 합니다</p>
...
<p class="post-section-heading">2. 호텔: 높은 탄력만큼 높은 변동성을 견뎌야 합니다</p>
...
<p class="post-section-heading">3. 오피스: 느리지만 단단하게, 그들만의 방어력을 보여줍니다</p>
...
<p class="post-section-heading">4. 모니터링 프레임워크: 네 가지 변수를 동시에 읽어야 합니다</p>
...
<p class="post-section-heading">5. 포트폴리오 관점에서의 결론: '승자'가 아닌 '전략'의 문제입니다</p>
...
- [ ] **호텔**: RevPAR 상승이 객실단가(ADR) 주도인지 가동률 주도인지 [JNTO](https://www.jnto.go.jp/) 통계로 확인하세요.
- [ ] **오피스**: 보유 자산의 테넌트 믹스를 감사하고, 향후 24개월 내 갱신 물량이 리스크인지 기회인지 판단하세요.
- [ ] **배분**: 엔고 시나리오에서 호텔의 수익 감익을 오피스의 안정성이 상쇄할 수 있도록 포트폴리오를 리밸런싱하세요.

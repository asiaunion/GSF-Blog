...
<p class="post-section-heading">1. 금리 인상은 가득이나 예민한 리츠의 '체력'과 '가치'를 동시에 건드립니다</p>
...
<p class="post-section-heading">2. 교훈 1: 정책 금리라는 이름표보다 '커브의 모양'이 훨씬 중요합니다</p>
...
우리가 지금 겪고 있는 2024\~2025 정상화 국면은 다행히 매우 신중한 경로를 밟고 있습니다. 시장이 충분히 소화할 수 있는 속도인 셈이죠. 하지만 제가 늘 모니터링하는 [BOJ 통계](https://www.boj.or.jp/en/statistics/index.htm/) 속의 **장단기 금리차(2년물과 10년물 스프레드)**가 좁아지기 시작한다면, 그때는 조심해야 할 신호라고 생각합니다.

<p class="post-section-heading">3. 교훈 2: 위기 때 실력이 드러나는 건 '부채의 품질'입니다</p>
...
<p class="post-section-heading">4. 교훈 3: 섹터마다 반응 속도가 다르다는 점을 이용해야 합니다</p>
...
<p class="post-section-heading">5. 결론: 단순히 '싸다'는 말에 현혹되지 마십시오</p>

현재 J-REIT의 평균 배당 수익률은 4.5\~5.0% 수준입니다. 일본 국채 금리에 비해 350\~400bp 정도 높은 수준인데, 역사적인 평균보다 스팬(Spread)이 넓어진 건 사실입니다. 단순히 이 숫자만 보면 "야, 정말 저렴하다!"라고 할 수 있지만, 저는 그 이면에 금리 인상이 실제 배당금을 얼마나 깎아 먹을 수 있는지를 먼저 계산해 봅니다.

제가 추천드리는 실천 프레임워크는 이렇습니다.
1. **만기 구조를 맵핑하십시오.** [JPX 공시](https://www.jpx.co.jp/english/)를 열어 앞으로 1, 2년 내에 돌아오는 빚이 얼마나 되는지 확인해 보시는 겁니다.
2. **배당 지속 가능성을 따져보십시오.** 금리가 0.5% 오를 때 배당금이 15% 이상 깎이는 리츠라면, 지금 아무리 수익률이 높게 찍혀도 그것은 기회가 아니라 함정일 확률이 높습니다.
3. **부동산 본연의 체력을 보십시오.** 금리가 오르더라도 월세를 더 받을 수 있는 힘(낮은 공실률, 높은 입지 품질)을 가진 리츠만이 이 상승 사이클의 최종 승자가 될 것입니다. 

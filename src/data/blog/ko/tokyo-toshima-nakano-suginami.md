...
| **구 전체 평균** | **약 124.5만엔/㎡** | **약 412만엔/坪**<sup class="source-ref"><a href="#source-3" id="cite-3">3</a></sup> |

재개발 발표 이후 이케부쿠로 서구 역세권 물건의 시세 상승이 가속되고 있습니다. 70㎡ 환산 시 구 전체 평균 매입가는 약 8,715만 엔 수준입니다.
...
| **구 전체 평균** | **약 121.1만엔/㎡** | **약 400만엔/坪**<sup class="source-ref"><a href="#source-3">3</a></sup> |

70㎡ 환산 시 구 평균 매입가는 약 8,474만 엔입니다. 도시마구와 거의 동급이지만, 구 면적이 훨씬 좁기 때문에 역 도보 거리 단축에 따른 가격 프리미엄 효율이 더 높습니다.
...
| **구 전체 평균** | **약 90.2만엔/㎡** | **약 298만엔/坪**<sup class="source-ref"><a href="#source-3">3</a></sup> |

70㎡ 환산 시 구 평균은 약 6,314만 엔입니다. 세 구 중 가장 낮은 진입 비용으로, 도시마·나카노 대비 약 25~33% 저렴하게 진입할 수 있습니다.
...
**매매가 격차 (뺄셈 검증):**
나카노구 평균(121.1만 엔/㎡) - 스기나미구 평균(90.2만 엔/㎡) = **30.9만 엔**의 차이입니다. (산술: 121.1 - 90.2 = 30.9) 스기나미구는 나카노구보다 ㎡당 약 25% 저렴하게 진입할 수 있습니다.
...
| **맨션 평균 ㎡ 단가** | 약 124.5만엔 | 약 121.1만엔 | 약 90.2만엔 |
...
매매가에서는 도시마(124.5만엔/㎡)와 스기나미(90.2만엔/㎡) 사이에 약 38% 격차가 벌어지지만, 1LDK 임대에서는 16.1만엔 vs 16.2만엔으로 사실상 동일합니다. 즉 **스기나미구는 훨씬 적은 초기 자본으로 매입하면서도, 임대 수익률(Income Gain) 측면에서는 도시마구와 동등한 성과를 낼 수 있습니다.**

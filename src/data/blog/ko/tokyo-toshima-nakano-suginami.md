...
citeSources:
  ...
  - label: "HOMES 도쿄도 중고 맨션 가격 시세 (구별 평균, 2026-05)"
...
|---------|---------------------|-----------------| 
| 이케부쿠로 역세권 (서구 중심) | 130~155만엔/㎡ | 430~510만엔/坪 |
| 메지로·스가모 방면 | 115~140만엔/㎡ | 380~465만엔/坪 |
| 오지마·이케부쿠로 외곽 | 100~120만엔/㎡ | 330~400만엔/坪 |
| **구 전체 평균** | **약 151.0만엔/㎡** | **약 499만엔/坪**<sup class="source-ref"><a href="#source-3" id="cite-3">3</a></sup> |

> ⚠️ **서브지역별 단가는 재검증 예정.** 구 전체 평균(151.0만엔/㎡, 70㎡ 환산 ≒10,568만엔)은 HOMES 70㎡ 인덱스 기준, 1차 확인 완료.

재개발 발표 이후 이케부쿠로 서구 역세권 물건의 시세 상승이 가속되고 있습니다. 70㎡ 환산 시 구 전체 평균 매입가는 약 1억 568만 엔 수준입니다.
...
| 서브지역 | ㎡ 단가 (2025~2026) | 坪(평) 단가 환산 |
|---------|---------------------|-----------------| 
| 나카노역 주변 (도보 5분 이내) | 125~150만엔/㎡ | 415~495만엔/坪 |
| 신사쿠라다이·고엔지마 방면 | 105~130만엔/㎡ | 345~430만엔/坪 |
| **구 전체 평균** | **약 119.1만엔/㎡** | **약 394만엔/坪**<sup class="source-ref"><a href="#source-3">3</a></sup> |

> ⚠️ **서브지역별 단가는 재검증 예정.** 구 전체 평균(119.1만엔/㎡, 70㎡ 환산 ≒8,340만엔)은 HOMES 1차 확인 완료.

70㎡ 환산 시 구 평균 매입가는 약 8,340만 엔입니다. 구 면적이 훨씬 좁기 때문에 역 도보 거리 단축에 따른 가격 프리미엄 효율이 더 높습니다.
...
| 서브지역 | ㎡ 단가 (2025~2026) | 坪(평) 단가 환산 |
|---------|---------------------|-----------------| 
| 고엔지·아사가야 역세권 | 95~125만엔/㎡ | 315~415만엔/坪 |
| 오기쿠보·니시오기쿠보 | 85~110만엔/㎡ | 280~365만엔/坪 |
| 미타카·무사시노 인접 외곽 | 75~95만엔/㎡ | 250~315만엔/坪 |
| **구 전체 평균** | **약 91.0만엔/㎡** | **약 301만엔/坪**<sup class="source-ref"><a href="#source-3">3</a></sup> |

> ⚠️ **서브지역별 단가는 재검증 예정.** 구 전체 평균(91.0만엔/㎡, 70㎡ 환산 ≒6,372만엔)은 HOMES 1차 확인 완료.

70㎡ 환산 시 구 평균은 약 6,372만 엔입니다. 세 구 중 가장 낮은 진입 비용으로, 도시마구 대비 약 40%, 나카노구 대비 약 24% 저렴하게 진입할 수 있습니다. (산술: 도시마 차이 151.0－91.0＝60.0만엔, 60.0÷151.0≒39.7%)
...
**매매가 격차 (뺄셈 검증):**
나카노구 평균(119.1만 엔/㎡) - 스기나미구 평균(91.0만 엔/㎡) = **28.1만 엔**의 차이입니다. (산술: 119.1 - 91.0 = 28.1) 스기나미구는 나카노구보다 ㎡당 약 24% 저렴하게 진입할 수 있습니다.
...
| **맨션 평균 ㎡ 단가** | 약 151.0만엔 | 약 119.1만엔 | 약 91.0만엔 |
| **70㎡ 환산 목안** | 약 1억 568만엔 | 약 8,340만엔 | 약 6,372만엔 |
...
매매가에서는 도시마(151.0만엔/㎡)와 스기나미(91.0만엔/㎡) 사이에 **약 40%의 격차**가 벌어지지만, 1LDK 임대에서는 16.1만엔 vs 16.2만엔으로 사실상 동일합니다. 즉 **스기나미구는 훨씬 적은 초기 자본으로 매입하면서도, 임대 수익률(Income Gain) 측면에서는 도시마구와 동등한 성과를 낼 수 있습니다.**

> **출처**: 구 전체 평균 단가는 HOMES 도쿄도 중고 맨션 인덱스(70㎡ 기준) 기반, 사용자 캡처 1차 확인 완료(2026년 6월). 서브지역별 수치는 별도 재검증 예정.

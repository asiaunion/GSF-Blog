...
sources:
  ...
  - "https://www.mlit.go.jp/report/press/content/001970012.pdf"
...
citeSources:
  ...
  - label: "미키 상사(三鬼商事) 도쿄 오피스 월별, 2026-03"
...
2. **공급 조건** — 도심 신축 맨션 공급이 타이트하다는 인식이 있지만, 공급량과 가격 하방의 인과는 지역·시기별로 따로 확인해야 합니다.
3. **낮은 오피스 공실률** — 미키 상사(三鬼商事) 2026년 3월 월별 데이터 기준 도심 5구 오피스 공실률은 **2.22%**<sup class="source-ref"><a href="#source-3" id="cite-3">3</a></sup>. 이 수치는 오피스 지표이며, 미나토·치요다 소형 주거 유닛의 공실·회전 속도는 별도 자료로 확인해야 합니다.
...
|------|------------|--------------|----------|
| **도심 3구** | 치요다·주오·미나토 | 600~1,000만 엔+ | 자산 가치 보전·시세차익 |
| **부도심 3구** | 신주쿠·시부야·분쿄 | 450~750만 엔 | 균형형(임대+시세) |
| **생활권** | 세타가야·스기나미·메구로 | 350~500만 엔 | 실거주 겸 투자 |
| **외곽** | 아다치·에도가와·가쓰시카 | 200~350만 엔 | 고수익률 추구 |
...
| 4 | **매수 의향서 제출** | 매수의향서(買付証明書, 카이츠케 쇼메이쇼) — 가격 네고는 이 단계에서 |
| 5 | **중요사항 설명** | 중요사항설명(重要事項説明, 주요지코 세츠메이) — 일본어 원문; 번역 필수 |
...
| 관리비·수선적립금 | 월 2만~5만 엔 | 월 1.5만~3만 엔 | 월 1만~2만 엔 |
| 공실 리스크 | 낮음 | 보통 | 높음 |

...
이러한 양극화 현상은 바다 건너 도쿄에서도 기시감 있게 관찰됩니다. 일본은행(BOJ)의 단계적 금리 인상 여파로 주담대 변동금리가 자극받기 시작하자, 도쿄 수도권 중고(기축) 맨션 시장은 코로나 이후의 긴 폭등세를 멈추고 2024년 9월 약 3년 만에 처음으로 보합(평당 단가 전월 대비 0.0% 정체) 국면에 진입[출처: 도쿄칸테이, '수도권 중고 맨션 70㎡ 가격 추이' 보고서, 2024-10-24]했습니다. 금리 부담을 느낀 실수요층의 추격 매수가 멈춘 결과입니다. 
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin: 24px 0; font-family: sans-serif;">
  <div style="background: rgba(128, 128, 128, 0.05); border: 1px solid rgba(128, 128, 128, 0.15); border-left: 4px solid var(--color-accent); padding: 20px; border-radius: 12px; backdrop-filter: blur(10px);">
    ...
    <p style="margin: 0; font-size: 14px; opacity: 0.9; line-height: 1.6;">
      ...
      • <strong>일본</strong>: BOJ 금리인상(2024년 7월 31일 연 0.25% 결정) ➔ 중고 맨션 평균가 <strong>3년 만에 보합</strong> (2024년 9월 기준)
    </p>
  </div>
  <div style="background: rgba(128, 128, 128, 0.05); border: 1px solid rgba(128, 128, 128, 0.15); border-left: 4px solid var(--color-accent); padding: 20px; border-radius: 12px; backdrop-filter: blur(10px);">

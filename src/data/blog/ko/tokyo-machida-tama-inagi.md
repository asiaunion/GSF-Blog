...
modDatetime: 2026-07-18T09:55:00+09:00
author: Joseph KIM
draft: false
gates:
  draft_started: true
...
- **마치다:** 하라마치다(原町田) 약 **68.9만엔/㎡**(거래수 45건)는 이번 세 시 중 가장 높습니다. 교통 프리미엄은 시 전체가 아니라 **주요 역 주변**에 붙고, 언덕·버스에 의존하는 지역은 **가격이 따로 움직입니다.**
...
시 평균 실제 거래가는 약 **46만엔/㎡**, 70㎡로 환산하면 약 **3,220만엔**, 거래수는 **300건**입니다.
...
여기서 주목할 점: **하라마치다만 뚜렷히 위로 튀고**, 코야마가오카는 시 평균 근처입니다. 교통 프리미엄을 「마치다 전체」로 읽기보다, **주요 역 주변에 붙고 언덕·버스에 의존하는 지역은 가격이 따로 움직인다**고 보는 편이 데이터에 가깝습니다.
...
데이터를 보며 인상이 바뀐 부분: **인구가 준다고 시 전체 거래가가 함께 식는 것은 아닙니다.** 세키도–도요가오카 약 3.2배 차이는 **어떤 동네에 수요가 남았는지**를 보여 줍니다. 싼 동네는 오래된 주택이 많아 가격이 눌린 것으로 볼 수 있고, 비싼 동네는 역이 가까워 수요가 몰린 것으로 볼 수 있습니다. 싼 곳만, 또는 비싼 곳만 골라 말하면 **전체 모습을 놓칩니다.**
...
시 평균 거래가 약 **40.4만엔/㎡**, 거래수 **106건**, 연평균 상승률 약 **1.4%**(표본·연도 변동에 민감 — 2025년 전년 대비는 −7.3%로 기록됨). 70㎡ 환산 약 **2,828만엔**. 신축 역 근처 1룸 임대료는 약 **7.9만엔/월**입니다.

**중요:** 이나기 동네별 거래수는 **모두 30건 미만**입니다. **거래수가 적어 동네별 ㎡당 가격은 직접 인용하지 않습니다.**
...
이나기 부분은 「전역 쇠퇴」와 다른 예를 보여 주면서, **거래수가 부족하면 성급히 결론 내리지 않는다**는 점을 밝히기 위함입니다.
...
매매가 차이는 약 14%인데 임대료 폭은 좁고, 단순 임대수익률은 거의 한곳에 모입니다. 이번 글에서는 **매매와 입지**를 중심으로 선입견을 다시 봅니다. 임대수익률은 **매매 가격과 임대료가 같은 방향으로만 움직이지는 않는다**는 점을 보여 주는 참고 수치입니다. 관리비·빈집·세금은 빼지 않았고, **특정 투자를 권하는 글이 아닙니다.**
...
타마시 **-5.9%**는 무시할 수 없습니다. 다만 같은 시 안에 세키도처럼 **㎡당 가격이 높은 동네**도 있습니다. 위험을 **시 이름만으로** 말하면, 동네마다 다른 현실을 놓칩니다.

**「가격이 오르고 있으니 이 지역은 이미 다시 좋아졌다」는 주장입니다.**

일부 동네의 거래가 상승은 사실입니다. 하지만 도요가오카처럼 여전히 싼 동네나, 이나기처럼 거래수가 적어 판단하기 어려운 곳까지 함께 보면, 「이미 다 올랐다」고 말하기는 어렵습니다. **가격은 금리·정책·시장 전체 흐름에도 영향을 받으므로, 이 표 하나로 결론 내릴 수 없습니다.**
...
> 숫자를 따라가며 제가 다시 묻게 된 것은 하나입니다. **타마 뉴타운이라는 이름보다, 어느 역·어느 동네인가가 먼저입니다.**
...
「실패했다」는 결론을 먼저 정해 두고 숫자를 끼워 맞추지 않습니다. **어느 동네·어느 철도 노선인가**를 먼저 묻고, 그다음에 기회와 위험을 나눕니다.

**아직 확신하기 어려운 부분**

이나기처럼 거래수가 적은 도시는 판단을 미뤄 둡니다.

**독자분들께 권하는 확인 순서**

1. 시 평균과 동네(또는 역 근처) 거래가를 **분리**
2. 주요 역·철도 축 vs 언덕·버스 의존 지역
3. 인구·재해(하자드맵)
4. 임대는 매매와 **다른 표**로

...
특히 2026년 현재, 일본은 단순히 부동산뿐만 아니라 닛케이(Nikkei) 주식 시장을 거쳐 자산 시장 전반에 확연한 '훈풍(온기)'이 돌고 있습니다. 잃어버린 30년이라는 꼬리표를 완전히 떼어내고 오피스 임대료 인상과 내수 회복이라는 선순환 사이클에 진입하면서, 우리는 상업용 리츠로부터의 안정적인 배당은 물론 괄목할 만한 시세 차익까지 듀얼(Dual)로 기대할 수 있는 완벽한 시기에 서 있습니다.

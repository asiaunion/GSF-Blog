...
sources:
  ...
  - "https://www.boj.or.jp/en/mops/mpo/mpm2026apr/mpm2026apr.pdf"
  - "https://www.boj.or.jp/"
...
citeSources:
  - label: "Real Estate Economic Institute: Tokyo Area New Mansion Market Trends April 2026"
    url: "https://www.fudousankeizai.co.jp/share/mansion/674/6fwGaeA1.pdf"
    portal: "https://www.fudousankeizai.co.jp/"
  - label: "REINS Market Watch April 2026 Summary"
    url: "https://www.reins.or.jp/pdf/trend/mw/mw_202604_summary.pdf"
    portal: "https://www.reins.or.jp/"
  - label: "REINS Data Section April 2026 (MW_202604data.pdf)"
    url: "https://www.reins.or.jp/pdf/trend/mw/MW_202604data.pdf"
    portal: "https://www.reins.or.jp/"
  - label: "BOJ Monetary Policy Statement April 28, 2026"
    url: "https://www.boj.or.jp/en/mops/mpo/mpm2026apr/mpm2026apr.pdf"
    portal: "https://www.boj.or.jp/"
  - label: "NTA Depreciation Calculation Formula No.2106"
    url: "https://www.nta.go.jp/taxes/shiraberu/taxanswer/shotoku/2106.htm"
    portal: "https://www.nta.go.jp/"
  - label: "NTA Pre-owned Asset Useful Life No.5404"
    url: "https://www.nta.go.jp/taxes/shiraberu/taxanswer/hojin/5404.htm"
    portal: "https://www.nta.go.jp/"
  - label: "MLIT Mansion Standard Management Bylaws Commentary"
...
For buildings acquired after April 2016, **only the straight-line method** is applied. This means you deduct the exact same amount as a depreciation expense every year.<sup class="source-ref"><a href="#source-5" id="cite-5">5</a></sup>
...
The reason tax-driven investments heavily favor pre-owned mansions is due to the **Simplified Method (簡便法)** formula specified in NTA No.5404.<sup class="source-ref"><a href="#source-6" id="cite-6">6</a></sup> For assets that have passed some or all of their statutory useful life, you calculate the remaining useful life using the following formula.

> **(Statutory Useful Life - Elapsed Years) + Elapsed Years × 20%**
> *Fractions are truncated. If the calculated years are less than 2, it is set to 2 years.*

| Scenario | Formula (Based on RC 47 Years) | Useful Life |
|------|--------|----------------|
...
According to the Ministry of Land, Infrastructure, Transport and Tourism (MLIT) Mansion Standard Management Bylaws commentary, repair reserve fund systems are broadly divided into two types.<sup class="source-ref"><a href="#source-7" id="cite-7">7</a></sup>
...
### Pre-owned Mansion Supply and Demand Trends in Core 3 Wards (April 2026)

| Indicator | Figure | YoY Change |
|------|------|------|
| Transactions (Contracted cases) | **238 cases** | **-9.2%** |
| Inventory (Listed cases) | **4,400 cases** | **+43.0%** |

<small>Source: REINS Data Section p.8 Ⅰ-3-(1) Contract Status, p.16 Ⅰ-3-(3) Inventory Status<sup class="source-ref"><a href="#source-3" id="cite-3">3</a></sup></small>
...
- [ ] **New Mansion Due Diligence**: Reflect the future increase schedule of the stepped-increase reserve method in your cash flow statement.
- [ ] **Pre-owned Mansion Due Diligence**: Check meeting minutes for the current repair reserve balance and any history of lump-sum contributions.
- [ ] **Exit Strategy Check**: Conservatively estimate the time required to sell, considering the increased inventory in the city center.
...
> **Fact-check standard for data cited in this article (April 2026):** Average price and initial month contract rate of new mansions (Real Estate Economic Institute)<sup class="source-ref"><a href="#source-1">1</a></sup>, pre-owned transaction/inventory status and Core 3 Wards inventory +43.0% (REINS)<sup class="source-ref"><a href="#source-2">2</a><a href="#source-3">3</a></sup>, BOJ policy rate maintained at 0.75% 6:3 (BOJ)<sup class="source-ref"><a href="#source-4">4</a></sup>, NTA useful life simplified method formula<sup class="source-ref"><a href="#source-6">6</a></sup>, MLIT repair lump sum commentary<sup class="source-ref"><a href="#source-7">7</a></sup>. Please be sure to verify the latest data from the original sources before making an investment decision.

---
title: "Adachi, Katsushika & Edogawa Home Prices — Eastern Tokyo [Ep.8·2026]"
...
citeSources:
  ...
  - label: "SUUMO Adachi-ku Rental Market Rates (new construction, within 5-min walk of station)"
    url: "https://suumo.jp/chintai/soba/tokyo/sc_adachi/"
  - label: "SUUMO Katsushika-ku Rental Market Rates (new construction, within 5-min walk of station)"
    url: "https://suumo.jp/chintai/soba/tokyo/sc_katsushika/"
  - label: "SUUMO Edogawa-ku Rental Market Rates (new construction, within 5-min walk of station)"
...
1. [足立区 (Adachi) — How Kita-Senju changed the narrative](#1-adachi-ku)
2. [葛飾区 (Katsushika) — A quiet 7.3% CAGR story](#2-katsushika-ku)
3. [江戸川区 (Edogawa) — Green space, family-first market](#3-edogawa-ku)
4. [3-Ward Comparison Summary](#4-comparison-summary)
5. [Investment & Relocation Guide](#5-guide)
...
_※ Cho-mei areas with n<30 excluded. Based on MLIT transaction price data by cho-mei._
...
Adachi-ku's transaction price per ㎡ rose from 47.4万円 in 2021 to 59.3万円 in 2025, a 4-year CAGR of **5.8%**.<sup class="source-ref"><a href="#source-1">1</a></sup>

_※ All CAGR figures in this series are calculated from 2021–2025 transaction price data._
...
Population forecast 2020→2040: **2.5%** — the most positive among the three wards in this episode.<sup class="source-ref"><a href="#source-5" id="cite-5">5</a></sup>
...
Katsushika-ku's 4-year transaction price CAGR is **7.3%** — the highest among the three wards in this episode, and competitive across the entire 23-ward series.<sup class="source-ref"><a href="#source-1">1</a></sup>
...
Katsushika-ku also carries flood and liquefaction risk of 'O' across tile sampling. The ward borders the Arakawa and Nakagawa rivers with significant low-lying sections. Population forecast 2020→2040: **0.8%**, marginal growth.<sup class="source-ref"><a href="#source-5">5</a></sup> Transaction volume (582 deals) is the lowest of the three wards — individual transaction price swings may have an outsized effect on ward-level averages.
...
Edogawa-ku's transaction price CAGR over 4 years stands at **5.8%**.<sup class="source-ref"><a href="#source-1">1</a></sup>
...
Population forecast 2020→2040: **1.1%** decline — the only declining projection among the three wards.<sup class="source-ref"><a href="#source-5">5</a></sup> A relevant long-term demand factor.
...
_Flood risk: based on MLIT tile sampling (tile sample ≠ entire ward). Individual property hazard map checks are essential._
_Chiyoda-ku figures: MLIT transaction price data, 2025, n=357._
...
1. Tokyo Metropolitan Government flood hazard map — designated flood zones, inundation depth
...
_Data in this article is drawn from the Ministry of Land, Infrastructure, Transport and Tourism Real Estate Information Library Completed Transaction Price Data (2025 Q1–Q4), SUUMO rental market figures (new construction, within 5-min walk of station), and Tokyo Metropolitan Government population projections. Always conduct individual property inspections and seek professional advice before making investment decisions._

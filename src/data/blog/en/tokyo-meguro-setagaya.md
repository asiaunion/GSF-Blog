...
| Item | Figure |
|------|------|
| Total Population | **283,913** (As of May 1, 2026)<sup class="source-ref"><a href="#source-1" id="cite-1">1</a></sup> |
...
The number of registered foreign residents in Meguro Ward is **12,563**, which translates to **approximately 4.42%** of the total population.<sup class="source-ref"><a href="#source-1" id="cite-1">1</a></sup> A significant number of Western corporate executives and multinational professionals reside in its upscale residential quarters.

...
<figure class="my-6">
  ...
  <figcaption class="text-center text-sm text-foreground/75 mt-2">Tree-lined streets and neighborhood scenery in Daikanyama, Tokyo</figcaption>
</figure>
...
<figure class="my-6">
  ...
  <figcaption class="text-center text-sm text-foreground/75 mt-2">Greenery and walkways in the Jiyugaoka area</figcaption>
</figure>
...
<figure class="my-6">
  ...
  <figcaption class="text-center text-sm text-foreground/75 mt-2">Omotesando shopping street with green surroundings</figcaption>
</figure>
...
<figure class="my-6">
  ...
  <figcaption class="text-center text-sm text-foreground/75 mt-2">Ginza department stores and upscale retail streets</figcaption>
</figure>
...
<figure class="my-6">
  ...
  <figcaption class="text-center text-sm text-foreground/75 mt-2">Shibuya redevelopment and cityscape near Scramble Crossing</figcaption>
</figure>

...
In [Ep.09](/posts/tokyo-musashino-mitaka-chofu/), I looked at the western premium belt centered on Musashino, Mitaka, and Chofu. This episode moves a little further west along the Chuo Line to cover **Kokubunji, Kunitachi, Fuchu, and Tachikawa** — four cities that make up what I call the Tama Education & Culture Belt.
...
- The four Tama cities are **not a single "cheap suburb"** — it is more accurate to see them as **four distinct markets** with different rail lines, redevelopment trajectories, and land uses.
- **Even within the same city**, prices per ㎡ diverge by **more than 3x** depending on the neighborhood (e.g., Tachikawa: Akebono-cho 83.4万 vs. Ichiban-cho 23.0万).
- **Despite wide purchase-price spreads**, new-build 1R rents near stations generally converge at **8.0–9.4万円/月**.
- **Population and income** are background context. What better explained price differences in this dataset was **station access, rail line, and redevelopment activity**.
- All four cities carry **flood and liquefaction risk flags**. When evaluating a specific neighborhood, cross-reference the relevant hazard maps separately.
...
| Income rank #1 **Kunitachi** vs. highest-price neighborhood **Kokubunji Honcho** | Income rank alone does not sort price rank. |
...
2. [Two living zones within Tachikawa](#2-two-living-zones-within-tachikawa)
3. [Purchase prices and rents move on different logics](#3-purchase-prices-and-rents-move-on-different-logics)
4. [Background data worth keeping in mind](#4-background-data-worth-keeping-in-mind)
5. [Four-city summary comparison](#5-four-city-summary-comparison)
6. [The same data, read differently](#6-the-same-data-read-differently)
7. [Who this may / may not help](#7-who-this-may--may-not-help)
...
A city with a strong **administrative and commercial sub-center** image. Tachikawa Station records approximately **30.1万 daily passengers**; combined city-station traffic approximately **52.6万/日**. ㎡ price: 42.1万 → **50.8万** (CAGR **4.8%**), 70㎡ ≈ **3,556万円** — **lowest city average among the four** (approximately **26.1%** of Chiyoda).
...
| City | Income | Ref: Municipal avg. 207.7 · 23-ward avg. 287.4 |
|----|--------|------------------------------------------------|
| Kunitachi | 191.9 | |
| Kokubunji | 179.7 | |
| Fuchu | 155.5 | |
...
- Want to evaluate location by **neighborhood, rail line, and redevelopment** rather than city name
- Prefer to read **purchase prices and rent/yield separately**
- Are considering **western hub or Tama zone** options outside the 23-ward budget
- Want to understand **the differences between four distinct markets** before committing to one

### This may not be a fit if you:

- Plan to conclude **"Tama = cheap"** based on the city name alone
- Are mapping **income rank = price rank** directly
- Are assessing without checking **hazard maps** (flood, liquefaction)
- Are targeting **city-level beta** for short-term price appreciation only
...
| Item | Reference |
|------|-----------|
| Condo ㎡ prices / transactions | MLIT Real Estate Information Library **Q1–Q4 2025** |
| Population projections | IPSS mesh **2020 → 2040** |
| Per-capita income | **FY2024** municipal income tax base ÷ **May 2026** Tokyo population estimate |
| SUUMO 1R | **2026-06-26** snapshot (new build, 1–5 min walk from station) |

<small>※ This article is personal analysis for informational purposes and does not constitute advice to buy or sell any specific property. Gross yield figures exclude management fees, vacancy, and taxes — for structural comparison only. Neighborhoods with fewer than 30 transaction cases should be read as directional reference only.</small>

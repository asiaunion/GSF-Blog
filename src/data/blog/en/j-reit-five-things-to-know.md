...
<figure class="my-6">
  ...
  <figcaption class="text-center text-sm text-foreground/75 mt-2">J-REIT market reference table (summary from japan-reit.com)</figcaption>
</figure>
...
<figure class="my-6">
  ...
  <figcaption class="text-center text-sm text-foreground/75 mt-2">Chart illustrating J-REIT dividend and yield context</figcaption>
</figure>
...
<figure class="my-6">
  ...
  <figcaption class="text-center text-sm text-foreground/75 mt-2">Nippon Building Fund (8951) price and facts screenshot</figcaption>
</figure>
...
<figure class="my-6">
  ...
  <figcaption class="text-center text-sm text-foreground/75 mt-2">Japan Real Estate Investment (8952) price and facts screenshot</figcaption>
</figure>
...
<figure class="my-6">
  ...
  <figcaption class="text-center text-sm text-foreground/75 mt-2">Nomura Real Estate Master Fund (3462) price and facts screenshot</figcaption>
</figure>

...
<svg viewBox="0 0 760 260" role="img" aria-label="Warm Investing Risk Framework" style="max-width:100%;height:auto;border:1px solid #e5e7eb;border-radius:8px;background:#fff;margin: 20px 0;">
  <text x="24" y="35" font-size="16" font-weight="700" fill="#111827">Trust-Return Equilibrium Model</text>
  ...
  <text x="660" y="220" font-size="12" fill="#64748b" text-anchor="end">Relational Trust</text>
  <text x="90" y="60" font-size="12" fill="#64748b" text-anchor="end" transform="rotate(-90 90,60)">Expected Yield</text>
  ...
  <text x="610" y="85" font-size="11" fill="#1d4ed8">High Risk/Return (Cold Speculation)</text>
</svg>

...
const ui = {
  en: {
    ...
    footerAdsNotice: "This site uses Google AdSense.",
    footerCopyright: "Copyright",
    footerAllRights: "All rights reserved.",
    heroTitleLine1: "Tokyo Real Estate",
    heroTitleLine2: "& J-REIT,",
    heroTitleLine3: "from the Inside",
    heroCtaRead: "Start Reading →",
    heroCtaAbout: "About the Author →",
    heroTagline: "Deep-dive analysis for Korean and\ncross-border investors —",
    heroDescription:
      "written from Nihonbashi by someone who lives here, owns here, and reads the data first.",
  ...
  ko: {
    ...
    footerCopyright: "Copyright",
    footerAllRights: "All rights reserved.",
    heroTitleLine1: "도쿄 부동산",
    heroTitleLine2: "J-REIT,",
    heroTitleLine3: "현장에서 씁니다",
    heroCtaRead: "글 읽기 →",
    heroCtaAbout: "운영자 소개 →",
    heroTagline: "니혼바시에 살며 직접 투자하는 사람이 쓰는",
    heroDescription:
      "한국인 투자자를 위한 일본 부동산 심층 분석",
  ...
  ja: {
    ...
    footerTerms: "利用規約",
    footerAdsNotice: "当サイトは Google AdSense を使用しています。",
    footerCopyright: "Copyright",
    footerAllRights: "All rights reserved.",
    heroTitleLine1: "東京不動産・",
    heroTitleLine2: "J-REIT、",
    heroTitleLine3: "現場から書く",
    heroCtaRead: "記事を読む →",
    heroCtaAbout: "著者について →",
    heroTagline: "日本橋在住・実物投資経験者による",
    heroDescription:
      "韓国人投資家・クロスボーダー投資家のための深掘り分析",

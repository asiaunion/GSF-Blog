...
const ui = {
  en: {
    ...
    heroTitleLine1: "Tokyo Real Estate & J-REIT,",
    heroTitleLine2: "from the Inside",
    heroCtaRead: "Start Reading →",
    heroCtaAbout: "About the Author →",
    heroTagline: "Deep-dive analysis for Korean and cross-border investors —",
    heroDescription:
  ...
  ko: {
    ...
    footerCopyright: "Copyright",
    footerAllRights: "All rights reserved.",
    heroTitleLine1: "도쿄 부동산·J-REIT,",
    heroTitleLine2: "현장에서 씁니다",
    heroCtaRead: "글 읽기 →",
    heroCtaAbout: "운영자 소개 →",
    ...
    langBannerText: "한국어·日本語·English로 제공됩니다",
    langBannerClose: "닫기",
    langBannerEn: "🇺🇸 English",
    langBannerKo: "🇰🇷 한국어",
    langBannerJa: "🇯🇵 日本語",
  ...
  ja: {
    ...
    footerCopyright: "Copyright",
    footerAllRights: "All rights reserved.",
    heroTitleLine1: "東京不動産・J-REIT、",
    heroTitleLine2: "現場から書く",
    heroCtaRead: "記事を読む →",
    heroCtaAbout: "著者について →",
    ...
    langBannerText: "日本語・한국어・Englishで読めます",
    langBannerClose: "閉じる",
    langBannerEn: "🇺🇸 English",
    langBannerKo: "🇰🇷 한국어",
    langBannerJa: "🇯🇵 日本語",
